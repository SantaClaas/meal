...
export default function TopAppBar({ header, leadingAction, trailingAction }) {
  return (
    <div
      ...
      class="sticky top-0 @container-scroll"
    >
      <header class="px-1 py-2 grid grid-cols-[3rem_1fr_3rem] gap-1 @stuck-top:bg-surface-container transition-colors ease-decelerate duration-medium-1 bg-surface">
        {leadingAction}
