...
export default function TopAppBar({ header, leadingAction, trailingAction }) {
  return (
    ...
    <header class="elevate dark:dark-elevate animate-elevate dark:animate-dark-elevate sticky top-0 px-1 min-h-[--h] [--h:theme(spacing.16)] py-2 grid grid-cols-[3rem,1fr,3rem] gap-1 bg-light-surface dark:bg-dark-surface">
      {leadingAction}
