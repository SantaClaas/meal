...
export default function TopAppBar({ header, leadingAction, trailingAction }) {
  return (
    ...
    <header class="sticky top-0 px-1 min-h-[--h] [--h:theme(spacing.16)] py-2 grid grid-cols-[3rem,1fr,3rem] gap-1 is-scrolled:bg-dark-surface-container transition-colors ease-decelerate duration-medium-1 bg-dark-surface">
      {leadingAction}
