...
export default function TopAppBar({ header, leadingAction, trailingAction }) {
  return (
    ...
    <header class="sticky top-0 px-1 min-h-[--h] [--h:theme(spacing.16)] py-2 grid grid-cols-[3rem_1fr_3rem] gap-1 is-scrolled:bg-light-surface-container dark:is-scrolled:bg-dark-surface-container transition-colors ease-decelerate duration-medium-1 bg-light-surface dark:bg-dark-surface sm:bg-light-surface-container dark:sm:bg-dark-surface-container is-scrolled:z-elevation-level-2">
      {leadingAction}
